...
all_city_zp_df = pd.read_csv('../../temp.csv', encoding='utf8')
...
all_city_zp_area_df = all_city_zp_area_df.rename(columns={0: "city", 1: "district", 2: "street",3:'123'})
all_city_zp_area_df.drop('123', axis=1, inplace=True)
...
engine = create_engine('mysql+pymysql://root:root@localhost:3306/bosszp_db?charset=utf8mb4')
